...
export default function PlaybookPage() {
  ...
  useEffect(() => {
    ...
    /* ── Parallax cover grid on scroll ── */
    const coverGrid = document.querySelector(".pb-cover-grid") as HTMLElement | null;
    const onParallax = () => {
      if (coverGrid) {
        const y = window.scrollY;
        coverGrid.style.transform = `translateY(${y * 0.3}px)`;
        coverGrid.style.opacity = `${Math.max(0, 0.4 - y * 0.0008)}`;
      }
    };
...
.pb-anim{opacity:0;transform:translateY(32px);transition:opacity 0.7s cubic-bezier(0.22,1,0.36,1),transform 0.7s cubic-bezier(0.22,1,0.36,1)}
.pb-anim.pb-visible{opacity:1;transform:translateY(0)}
.pb-anim-left{opacity:0;transform:translateX(-40px);transition:opacity 0.7s cubic-bezier(0.22,1,0.36,1),transform 0.7s cubic-bezier(0.22,1,0.36,1)}
.pb-anim-left.pb-visible{opacity:1;transform:translateX(0)}
.pb-anim-right{opacity:0;transform:translateX(40px);transition:opacity 0.7s cubic-bezier(0.22,1,0.36,1),transform 0.7s cubic-bezier(0.22,1,0.36,1)}
.pb-anim-right.pb-visible{opacity:1;transform:translateX(0)}
.pb-anim-scale{opacity:0;transform:scale(0.92);transition:opacity 0.6s cubic-bezier(0.22,1,0.36,1),transform 0.6s cubic-bezier(0.22,1,0.36,1)}
.pb-anim-scale.pb-visible{opacity:1;transform:scale(1)}
.pb-anim-fade{opacity:0;transition:opacity 0.8s ease}
.pb-anim-fade.pb-visible{opacity:1}

/* Stagger children delays */
.pb-stagger > *:nth-child(1){transition-delay:0s}
.pb-stagger > *:nth-child(2){transition-delay:0.08s}
.pb-stagger > *:nth-child(3){transition-delay:0.16s}
.pb-stagger > *:nth-child(4){transition-delay:0.24s}
.pb-stagger > *:nth-child(5){transition-delay:0.32s}
.pb-stagger > *:nth-child(6){transition-delay:0.4s}
.pb-stagger > *:nth-child(7){transition-delay:0.48s}
.pb-stagger > *:nth-child(8){transition-delay:0.56s}
.pb-stagger > *:nth-child(9){transition-delay:0.64s}
.pb-stagger > *:nth-child(10){transition-delay:0.72s}
.pb-stagger > *:nth-child(11){transition-delay:0.8s}
.pb-stagger > *:nth-child(12){transition-delay:0.88s}
.pb-stagger > *:nth-child(13){transition-delay:0.96s}
.pb-stagger > *:nth-child(14){transition-delay:1.04s}
.pb-stagger > *:nth-child(15){transition-delay:1.12s}
.pb-stagger > *:nth-child(16){transition-delay:1.2s}

/* ── COVER ENTRANCE ANIMATIONS ── */
@keyframes pb-coverBadge{from{opacity:0;transform:translateY(-16px)}to{opacity:1;transform:translateY(0)}}
@keyframes pb-coverTitle{from{opacity:0;transform:translateY(40px);filter:blur(8px)}to{opacity:1;transform:translateY(0);filter:blur(0)}}
@keyframes pb-coverSub{from{opacity:0;transform:translateY(24px)}to{opacity:1;transform:translateY(0)}}
@keyframes pb-coverMeta{from{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}
@keyframes pb-gridFade{from{opacity:0}to{opacity:0.4}}
.pb-cover-badge{animation:pb-coverBadge 0.8s cubic-bezier(0.22,1,0.36,1) 0.1s both}
.pb-cover h1{animation:pb-coverTitle 1s cubic-bezier(0.22,1,0.36,1) 0.3s both}
.pb-cover-sub{animation:pb-coverSub 0.8s cubic-bezier(0.22,1,0.36,1) 0.6s both}
.pb-cover-meta{animation:pb-coverMeta 0.8s cubic-bezier(0.22,1,0.36,1) 0.8s both}
.pb-cover-grid{animation:pb-gridFade 2s ease 0.2s both}

/* ── ENHANCED HOVER EFFECTS ── */
.pb-feature-card{background:var(--bg3);border:1px solid var(--border);border-radius:12px;padding:1.8rem;transition:border-color 0.3s ease,transform 0.3s ease,box-shadow 0.3s ease,background 0.3s ease}
.pb-feature-card:hover{border-color:var(--gold-border);transform:translateY(-4px);box-shadow:0 12px 40px rgba(201,146,42,0.08);background:rgba(17,17,17,0.9)}
.pb-feature-icon{width:44px;height:44px;background:var(--gold-dim);border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:1.3rem;margin-bottom:1.2rem;transition:transform 0.3s ease,background 0.3s ease}
.pb-feature-card:hover .pb-feature-icon{transform:scale(1.12) rotate(-3deg);background:rgba(201,146,42,0.18)}
.pb-toc-row{display:flex;align-items:center;gap:1rem;padding:1rem 1.4rem;background:var(--bg3);border:1px solid var(--border);border-radius:10px;transition:border-color 0.3s ease,transform 0.3s ease,box-shadow 0.3s ease,background 0.3s ease,padding-left 0.3s ease;text-decoration:none}
.pb-toc-row:hover{border-color:var(--gold-border);transform:translateX(6px);box-shadow:0 4px 20px rgba(201,146,42,0.06);background:rgba(17,17,17,0.8);text-decoration:none}
.pb-toc-row:hover .pb-toc-row-arrow{color:var(--gold);transform:translateX(4px)}
.pb-toc-row-arrow{color:var(--dim);font-size:0.8rem;transition:color 0.3s ease,transform 0.3s ease}
.pb-recipe-card{background:var(--bg3);border:1px solid var(--border);border-radius:14px;padding:2rem;margin-bottom:1.5rem;transition:border-color 0.3s ease,transform 0.3s ease,box-shadow 0.3s ease}
.pb-recipe-card:hover{border-color:var(--gold-border);transform:translateY(-3px);box-shadow:0 16px 48px rgba(201,146,42,0.06)}
.pb-callout{border-radius:12px;padding:1.8rem 2rem;margin:2rem 0;transition:transform 0.3s ease,box-shadow 0.3s ease}
.pb-callout:hover{transform:translateY(-2px);box-shadow:0 8px 30px rgba(0,0,0,0.15)}
.pb-code-block{background:#0D0D0D;border:1px solid var(--border2);border-radius:10px;overflow:hidden;margin:1.8rem 0;transition:border-color 0.3s ease,box-shadow 0.3s ease}
.pb-code-block:hover{border-color:rgba(201,146,42,0.15);box-shadow:0 4px 24px rgba(0,0,0,0.2)}
.pb-trouble-item{border:1px solid var(--border);border-radius:10px;margin-bottom:1rem;overflow:hidden;transition:border-color 0.3s ease,transform 0.3s ease}
.pb-trouble-item:hover{border-color:var(--gold-border);transform:translateY(-2px)}
.pb-channel-pill{display:flex;align-items:center;gap:8px;padding:8px 16px;background:var(--bg3);border:1px solid var(--border);border-radius:100px;font-family:var(--sans);font-size:0.8rem;color:var(--muted);transition:border-color 0.3s ease,color 0.3s ease,transform 0.3s ease,background 0.3s ease}
.pb-channel-pill:hover{border-color:var(--gold-border);color:var(--gold);transform:translateY(-3px) scale(1.03);background:rgba(201,146,42,0.06)}
.pb-policy-block{background:#060606;border:1px solid rgba(59,130,246,0.2);border-radius:10px;overflow:hidden;margin:2rem 0;transition:border-color 0.3s ease,box-shadow 0.3s ease}
.pb-policy-block:hover{border-color:rgba(59,130,246,0.35);box-shadow:0 4px 24px rgba(59,130,246,0.06)}
.pb-arch-diagram{background:var(--bg3);border:1px solid var(--border);border-radius:14px;padding:2.5rem;margin:2rem 0;text-align:center;transition:border-color 0.3s ease}
.pb-arch-diagram:hover{border-color:var(--gold-border)}
.pb-arch-box{background:var(--bg4);border:1px solid var(--border2);border-radius:8px;padding:0.7rem 1.2rem;font-family:var(--sans);font-size:0.78rem;color:var(--cream);font-weight:500;min-width:110px;text-align:center;transition:transform 0.3s ease,box-shadow 0.3s ease}
.pb-arch-box:hover{transform:translateY(-2px);box-shadow:0 4px 16px rgba(0,0,0,0.2)}
.pb-step-num{min-width:40px;height:40px;background:var(--gold-dim);border:1px solid var(--gold-border);border-radius:50%;display:flex;align-items:center;justify-content:center;font-family:var(--mono);font-size:0.8rem;color:var(--gold);font-weight:600;flex-shrink:0;margin-top:2px;transition:transform 0.3s ease,background 0.3s ease,box-shadow 0.3s ease}
.pb-step:hover .pb-step-num{transform:scale(1.15);background:rgba(201,146,42,0.2);box-shadow:0 0 16px rgba(201,146,42,0.15)}
.pb-checklist li{display:flex;align-items:flex-start;gap:0.8rem;padding:0.7rem 0;border-bottom:1px solid var(--border);font-family:var(--sans);font-size:0.88rem;color:var(--muted);transition:padding-left 0.3s ease,color 0.3s ease}
.pb-checklist li:hover{padding-left:8px;color:var(--cream)}

/* ── CHAPTER DIVIDER ANIMATION ── */
.pb-chapter-divider{width:48px;height:2px;background:var(--gold);margin-bottom:2rem;transition:width 0.6s cubic-bezier(0.22,1,0.36,1)}
.pb-visible .pb-chapter-divider,.pb-chapter-header:hover .pb-chapter-divider{width:80px}

/* ── CTA SECTION GLOW ── */
@keyframes pb-ctaGlow{0%,100%{box-shadow:0 0 40px rgba(201,146,42,0.05)}50%{box-shadow:0 0 80px rgba(201,146,42,0.12)}}
.pb-cta-section{animation:pb-ctaGlow 4s ease-in-out infinite}
.pb-btn-primary{background:var(--gold);color:#0A0A0A;font-family:var(--sans);font-size:0.82rem;font-weight:700;letter-spacing:0.12em;padding:16px 36px;border-radius:100px;transition:opacity 0.2s,transform 0.3s ease,box-shadow 0.3s ease;text-decoration:none;display:inline-block}
.pb-btn-primary:hover{opacity:0.9;transform:translateY(-2px);box-shadow:0 8px 32px rgba(201,146,42,0.3);text-decoration:none}
.pb-btn-secondary{background:transparent;color:var(--cream);font-family:var(--sans);font-size:0.82rem;font-weight:600;letter-spacing:0.12em;padding:16px 36px;border-radius:100px;border:1px solid var(--border2);transition:border-color 0.3s ease,color 0.3s ease,transform 0.3s ease;text-decoration:none;display:inline-block}
.pb-btn-secondary:hover{border-color:var(--gold-border);color:var(--gold);transform:translateY(-2px);text-decoration:none}

/* ── TABLE ROW HOVER ── */
.pb-table-wrap tbody tr{transition:background 0.2s ease}
.pb-table-wrap tbody tr:hover td{background:rgba(201,146,42,0.04)}

/* ── SIDEBAR NAV LINK ANIMATION ── */
.pb-nav-link{display:flex;align-items:center;gap:10px;padding:0.55rem 1.5rem;font-family:var(--sans);font-size:0.82rem;color:var(--muted);transition:all 0.25s cubic-bezier(0.22,1,0.36,1);cursor:pointer;border-left:3px solid transparent;text-decoration:none}
.pb-nav-link:hover,.pb-nav-link.active{color:var(--gold);border-left-color:var(--gold);background:var(--gold-mid);text-decoration:none;padding-left:1.8rem}

/* ── SMOOTH SCROLL OVERRIDE ── */
@media(prefers-reduced-motion:reduce){
  .pb-anim,.pb-anim-left,.pb-anim-right,.pb-anim-scale,.pb-anim-fade{opacity:1;transform:none;transition:none}
  .pb-cover-badge,.pb-cover h1,.pb-cover-sub,.pb-cover-meta,.pb-cover-grid{animation:none;opacity:1}
  .pb-cta-section{animation:none}
}
      ...
      <div className="pb-main-content">
        ...
        <section className="pb-section" id="toc">
          <div className="pb-container">
            <div className="pb-chapter-header pb-anim">
            ...
            <div className="pb-toc-grid pb-anim pb-stagger">
        ...
        <section className="pb-section" id="ch1">
          <div className="pb-container">
            ...
            <div className="pb-callout pb-callout-gold pb-anim">
        ...
        <section className="pb-section" id="ch2">
          <div className="pb-container">
            ...
            <div className="pb-arch-diagram pb-anim-scale pb-anim">
        ...
        <section className="pb-section" id="ch3">
          <div className="pb-container">
            ...
            <div className="pb-table-wrap pb-anim">
              <table>
        ...
        <section className="pb-section" id="ch5">
          <div className="pb-container">
            ...
            <ul className="pb-checklist pb-anim">
    ...
    -d text="OpenShell DENY: \${line}"
        ...
        <section className="pb-section" id="ch15">
          <div className="pb-container">
            ...
            <div className="pb-trouble-item pb-anim">
        ...
        <section className="pb-section" id="ch16">
          <div className="pb-container">
            ...
            <div className="pb-cta-section pb-anim-scale pb-anim">
